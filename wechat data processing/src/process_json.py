...
input_str = open("data/articles.json", encoding="utf8")
output_file_path = "data/outputFull.txt"
if os.path.exists(output_file_path):
    os.remove(output_file_path)
output_file = open(output_file_path, mode="a")
# datastore = json.load(input_str)

for x in input_str:
    datastore = json.loads(x)
    line = datastore['content']
...
# output_file_path = "output_seg.txt"
# if os.path.exists(output_file_path):
#     os.remove(output_file_path)
# output_file = open(output_file_path, mode="a")
# input_str = open("data/2.txt", encoding="utf8").read()
